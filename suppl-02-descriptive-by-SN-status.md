...
## 1        yes 20 41.8       0.95      38.3      45.4
## 2         no 63 37.7       0.95      35.5      40.0
```
...
<img src="./figures/suppl-02-descriptive-by-SN-status/age-1.png" width="576" style="display: block; margin: auto;" />
...
## 1 83           4.117       0.95    -0.133     8.585           yes
```
...
<img src="./figures/suppl-02-descriptive-by-SN-status/age-2.png" width="576" style="display: block; margin: auto;" />
...
```
##   sn_present  n Mean Conf.level Bca.lower Bca.upper
## 1        yes 20 73.0       0.95      66.3      81.9
## 2         no 63 63.9       0.95      60.5      67.7
```
...
<img src="./figures/suppl-02-descriptive-by-SN-status/mass-1.png" width="576" style="display: block; margin: auto;" />
...
```
##    n Mean.difference Conf.level Bca.lower Bca.upper Includes.zero
## 1 83           9.035       0.95     1.122    18.457            no
```
...
<img src="./figures/suppl-02-descriptive-by-SN-status/mass-2.png" width="576" style="display: block; margin: auto;" />
...
<img src="./figures/suppl-02-descriptive-by-SN-status/height-1.png" width="576" style="display: block; margin: auto;" />
...
```
##    n Mean.difference Conf.level Bca.lower Bca.upper Includes.zero
## 1 37           0.028       0.95    -0.003     0.058           yes
```
...
<img src="./figures/suppl-02-descriptive-by-SN-status/height-2.png" width="576" style="display: block; margin: auto;" />
...
<img src="./figures/suppl-02-descriptive-by-SN-status/height-3.png" width="576" style="display: block; margin: auto;" />
...
## 1        yes 20      0.400       0.95      0.15     0.550
...
<img src="./figures/suppl-02-descriptive-by-SN-status/sex-1.png" width="576" style="display: block; margin: auto;" />
...
## 1 83      0.443       0.95      0.14     1.268          yes
```
...
<img src="./figures/suppl-02-descriptive-by-SN-status/sex-2.png" width="576" style="display: block; margin: auto;" />
...
## 1        yes 20    200       0.95        77       290
## 2         no 63    235       0.95       149       286
```
...
<img src="./figures/suppl-02-descriptive-by-SN-status/cd4-1.png" width="576" style="display: block; margin: auto;" />
...
<img src="./figures/suppl-02-descriptive-by-SN-status/cd4-2.png" width="576" style="display: block; margin: auto;" />
...
<img src="./figures/suppl-02-descriptive-by-SN-status/viral_load-1.png" width="576" style="display: block; margin: auto;" />
...
```
##    n Median.difference Conf.level Bca.lower Bca.upper Includes.zero
## 1 77            -0.132       0.95     -1.14     1.079           yes
```
...
<img src="./figures/suppl-02-descriptive-by-SN-status/viral_load-2.png" width="576" style="display: block; margin: auto;" />
...
```
##   sn_present  n Median Conf.level Bca.lower Bca.upper
## 1        yes  2    7.5       0.95       4.0       7.5
## 2         no 14    9.0       0.95       3.5      13.0
```
...
<img src="./figures/suppl-02-descriptive-by-SN-status/alcohol-1.png" width="576" style="display: block; margin: auto;" />
...
<img src="./figures/suppl-02-descriptive-by-SN-status/tb_current-1.png" width="576" style="display: block; margin: auto;" />
...
## 1 83      0.157       0.95     0.042     0.553            no
```
...
<img src="./figures/suppl-02-descriptive-by-SN-status/tb_current-2.png" width="576" style="display: block; margin: auto;" />
...
<img src="./figures/suppl-02-descriptive-by-SN-status/tb_rifafour-1.png" width="576" style="display: block; margin: auto;" />
...
```
##    n Odds.ratio Conf.level Bca.lower Bca.upper Includes.zero
## 1 83      0.255       0.95     0.074     0.853            no
```
...
<img src="./figures/suppl-02-descriptive-by-SN-status/tb_rifafour-2.png" width="576" style="display: block; margin: auto;" />
...
##  [1] bindrcpp_0.2.2   skimr_1.0.3      rcompanion_2.0.0 boot_1.3-20     
